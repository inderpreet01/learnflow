...
import { getCatalogPageData } from "../service/operations/pageAndComponent"
          ...
          <div className=" mx-auto box-content w-full max-w-maxContentTab px-4 py-12 lg:max-w-maxContent">
            ...
            <div className="py-8">
              <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                { catalogPageData?.data?.mostSellingCourses?.slice(0, 4).map((courses, i) => (
                           <CourseCard course = {courses} key = {i} Height = {"h-[400px]"} /> ))
                  }
              </div>
            </div>
          </div>
